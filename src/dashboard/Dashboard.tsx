            ...
            <nav id="sidebar" className="sidebar-wrapper sidebar-dark">
                <div className="sidebar-content">
                    ...
                    <ul className="sidebar-menu border-t border-white/10" data-simplebar >
                        ...
                        <li>
                            <a href="explore-property.html"><i className="mdi mdi-home-city me-2"></i>Profile</a>
                        </li>

                        <li className="sidebar-dropdown">
                            <a href="javascript:void(0)"><i className="mdi mdi-account-edit me-2"></i>Masterdata</a>
                            <div className="sidebar-submenu">
                                <ul>
                                    <li className="sidebar-dropdown">
                                        <a href="javascript:void(0)"><i className="mdi mdi-account-edit me-2"></i>Location</a>
                                        <div className="sidebar-submenu">
                                            <ul>
                                    ...
                                    <li className="sidebar-dropdown">
                                        <a href="javascript:void(0)"><i className="mdi mdi-account-edit me-2"></i>Metadata</a>
                                        <div className="sidebar-submenu">
                                            <ul>
                                                <li><a href="">Blood Group</a></li>
                                                <li><a href="">Gender Type</a></li>
                                                <li><a href="">Marital Status</a></li>
                                                <li><a href="">Doctor Specializations</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <li className="sidebar-dropdown">
                            <a href="javascript:void(0)"><i className="mdi mdi-file-document-outline me-2"></i>Setup</a>
                            <div className="sidebar-submenu">
                                <ul>
                                    <li className="sidebar-dropdown">
                                        <a href="javascript:void(0)"><i className="mdi mdi-file-document-outline me-2"></i>Manage Organization</a>
                                        <div className="sidebar-submenu">
                                            <ul>
                                                ...
                                                <li><a href="">Lab Scheme</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li><a href="">Doctor Informations</a></li>
                                    <li><a href="">Unregistered Doctor</a></li>
                                    <li><a href="">Agent Information</a></li>
                                    <li><a href="">Doctor Request</a></li>
                                    <li className="sidebar-dropdown">
                                        <a href="javascript:void(0)"><i className="mdi mdi-file-document-outline me-2"></i>URM</a>
                                        <div className="sidebar-submenu">
                                            <ul>
                        ...
                        <li className="sidebar-dropdown">
                            <a href="javascript:void(0)"><i className="mdi mdi-post-outline me-2"></i>My Plans</a>
                            <div className="sidebar-submenu">
                                <ul>
                        ...
                        <li className="relative lg:m-8 m-6 px-8 py-8 rounded-lg bg-gradient-to-b to-transparent from-slate-800 text-center">
                        <div className="sidebar-brand">
                            <a href="/"><img src="assets/images/logo.png" className="h-12" alt=""></img></a>
                        </div>
                ...
                <div className="container-fluid relative px-3">
                    <div className="layout-specing">
                        ...
                        <div className="text-center">
                            <h2 className="h1s pb-6">Welcome To Rudra Clinic</h2>
                            <p>We are delighted to provide you with a comprehensive, user-friendly platform designed to cater to all your healthcare needs. Whether you're scheduling a consultation with a doctor, booking a patholab test, or ordering medications from our pharmacy, your dashboard offers a seamless and efficient experience. Here's a closer look at the services available to you.</p>
                            <p className="font-semibold">Welcome to a new era of personalized healthcare management!</p>
                        </div>
                            ...
                            <div className="xl:w-1/3 lg:w-1/3 md:w-1/2 p-3 picture-item">   
                                <div className="violet rounded-lg shadow-z dark:shadow-gray-800 p-6">
                                    <div className="flex items-center border-gray-100 dark:border-gray-800">
                                        ...
                                        <div className="ps-4">
                                            <div className="text-center">
                                                <a href="#" className="text-lg hover:text-green-600 font-semibold duration-500 ease-in-out">Dr. Consultation</a>
                                            </div>
                            ...
                            <div className="xl:w-1/3 lg:w-1/3 md:w-1/2 p-3 picture-item">    
                                <div className="orange rounded-lg shadow-z dark:shadow-gray-800 p-6">
                                    <div className="flex items-center border-gray-100 dark:border-gray-800">
                                        ...
                                        <div className="ps-4">
                                            <div className="text-center">
                                                <a href="#" className="text-lg hover:text-green-600 font-semibold duration-500 ease-in-out">Laboratory</a>
                                            </div>
                                            <p className="text-slate-400 text-1xl">PALASUNI, BHUBANESWAR, KHURDA, ODISHA, INDIA-754001</p>
                                        </div>
                            ...
                            <div className="xl:w-1/3 lg:w-1/3 md:w-1/2 p-3 picture-item">    
                                <div className="sky-blue rounded-lg shadow-z dark:shadow-gray-800 p-6">
                                    <div className="flex items-center border-gray-100 dark:border-gray-800">
                                        ...
                                        <div className="ps-4">
                                            <div className="text-center">
                                                <a href="#" className="text-lg hover:text-green-600 font-semibold duration-500 ease-in-out">Pharmacy</a>
                                            </div>
                                            <p className="text-slate-400 text-1xl">PALASUNI, BHUBANESWAR, KHURDA, ODISHA, INDIA-754001</p>
                                        </div>
